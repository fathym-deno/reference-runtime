...
export type DetermineEaCFluentMethods<
  ...
  K extends keyof T,
  TBuilderModel,
> = T extends infer U ? K extends keyof U ? DetermineFluentMethodsType<U, K> extends infer MethodType ? MethodType extends keyof FluentMethodsMap<U, K, TBuilderModel> ? FluentMethodsMap<U, K, TBuilderModel>[MethodType]
